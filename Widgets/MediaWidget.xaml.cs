...
{
    public sealed partial class MediaWidget : Window
    {
        ...
        private void SetupWindow()
        {
            ...
            AppWindow.Resize(new SizeInt32(300, 100));
        ...
        private void SavePosition() { Settings.Values["Media.PosX"] = AppWindow.Position.X; Settings.Values["Media.PosY"] = AppWindow.Position.Y; }
        private PointInt32 LoadPosition() => new(Settings.Values["Media.PosX"] is int x ? x : 360, Settings.Values["Media.PosY"] is int y ? y : 40);
    }
}