...
{
    public sealed partial class NotesWidget : Window
    {
        ...
        private void SetupWindow()
        {
            ...
            AppWindow.Resize(new SizeInt32(260, 260));
        ...
        private void SavePosition() { Settings.Values["Notes.PosX"] = AppWindow.Position.X; Settings.Values["Notes.PosY"] = AppWindow.Position.Y; }
        private PointInt32 LoadPosition() => new(Settings.Values["Notes.PosX"] is int x ? x : 680, Settings.Values["Notes.PosY"] is int y ? y : 40);
    }
}