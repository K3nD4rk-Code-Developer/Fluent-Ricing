...
{
    public sealed partial class CalendarWidget : Window
    {
        ...
        private void SetupWindow()
        {
            ...
            AppWindow.Resize(new SizeInt32(280, 300));
        ...
        private void SavePosition() { Settings.Values["Calendar.PosX"] = AppWindow.Position.X; Settings.Values["Calendar.PosY"] = AppWindow.Position.Y; }
        private PointInt32 LoadPosition() => new(Settings.Values["Calendar.PosX"] is int x ? x : 360, Settings.Values["Calendar.PosY"] is int y ? y : 300);
    }
}